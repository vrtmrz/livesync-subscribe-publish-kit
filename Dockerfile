...
WORKDIR /app
RUN git clone --recursive https://github.com/vrtmrz/hugoconfig-livesync-publisher hugosite
RUN git clone --recursive https://github.com/vrtmrz/livesync-subscribe-publish subscriber
